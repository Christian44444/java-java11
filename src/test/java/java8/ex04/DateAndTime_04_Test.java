...
public class DateAndTime_04_Test {
    ...
    public void test_localDateTime_of() {
        ...
        result = LocalDateTime.of(LocalDate.of(2018, 1, 1), LocalTime.of(12, 0, 0));
    ...
    public void test_localDateTime_parse() {
        ...
        LocalDateTime result = null;
        result = LocalDateTime.parse("2009-03-02T09:30:00");
        // TODO valoriser les différentes variables afin de rendre le test passant
        int hour = 0;
        int minutes = 0;
        int second = 0;
    ...
    public void test_localDateTime_format() {
        ...
        localDateTime = LocalDateTime.of(2017, 11, 27, 12, 0, 0);
        // TODO Formatter l'heure pour que le test soit passant
        String result = null;
        result = localDateTime.format(DateTimeFormatter.ofPattern("yyyy - MM/dd hh:mm"));
